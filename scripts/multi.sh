...
python scripts/analyze_multiview_latent_consistency.py \
    --dataset co3d_native \
    --checkpoints \
        "checkpoints/natural-illegal-bullmastiff-from-tartarus_EQ-VAE on CO3D hydrant 50seq cropped, matched to warp_vae_hydrant_recon_crop runs/vae-stepstep=055000.ckpt" \
    ...
    --model_names "EQ-VAE" "Warp-VAE (L1)" "Warp-VAE (Cosine)" \
    --mode roma \
    --roma_setting turbo \
    --roma_confidence_threshold 0.2 \
    --max_distance 3.0 \
    --min_distance 0.5 \
    --co3d_native_dir /visinf/projects_students/dlcv2025_groupZ/co3d_data \
    --output_name final_comparison_co3d