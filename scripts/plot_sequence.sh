source /visinf/home/lab_mozkan/miniconda3/etc/profile.d/conda.sh && conda activate cv && CUDA_VISIBLE_DEVICES=0 python scripts/analyze_multiview_latent_consistency.py \
